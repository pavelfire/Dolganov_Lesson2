    ...
    init {
        ...
        addItem(
            VacancyItem(
                ...
                "разрабатывать приложения на платформе Android;\n" +
                        "оценивать сложность разработки, планировать и работать по спринтам (Agile/Scrum);\n" +
                        "разрабатывать unit-тесты, проводить рефакторинг и code review;\n" +
                        "управлять командой разработки.",
                "опыт разработки под Android от 7-ми лет;\n" +
                        "опыт работы на Java и Kotlin от 5-ти лет;\n" +
                        "опыт управления командой разработки;\n" +
                        "опыт работы с проектом, где DAU от 10 000 человек;\n" +
                        ...
                        "опыт оптимизации сложного UI;\n" +
                        "опыт оптимизации технических метрик приложения.",
                "Хорошая зарплата\n" +
                        "\n" +
